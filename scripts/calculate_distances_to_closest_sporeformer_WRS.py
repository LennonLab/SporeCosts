...
tree_file_path = '%sRAxML_parsimonyTree.output_tree' % data_directory
...
#print(tree.get_distance(str(spore_formers[0]), str(spore_formers[1])))


print(mapping_df)

print( mapping_df[mapping_df['Genome_ID'] == 'genome_1903704']['Gene_ID'].tolist())
